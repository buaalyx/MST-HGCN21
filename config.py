...
config_args = {
    'training_config': {
        ...
        'consis-rate': (1.0, 'the ratio of consis loss in integral loss'),
        'tem': (0.5, 'Sharpening temperature')
    },
    'model_config': {
        ...
        'use-bn': (0, 'whether to use batchnorm'),
        'num-adj': (1, 'num of adj matrix'),
        'spt-alg':("kruskal", 'algorithm used in spt, prim or kruskal'),
        'spt-attr':("edge_degree", 'attribute used in spt, edge_degree or similarity'),
        'add-rate': (0.5, 'rate of add edge on SPT')
    },
    'data_config': {
